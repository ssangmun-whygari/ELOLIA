									...
									<c:forEach var="review" items="${writtenReviews}">
										<div class="cart-single-list">
											<div class="row align-items-center">
												...
												<c:url var="writeReviewUrl" value="/review/writeReview">
													<c:param name="product_no" value="${review.product_no}"/>
													<c:param name="product_name" value="${review.product_name}"/>
												</c:url>
												<div class="col-lg-2 col-md-2 col-12">
													<a href="${writeReviewUrl}">리뷰작성</a>
												</div>
											</div>
										</div>
									</c:forEach>
