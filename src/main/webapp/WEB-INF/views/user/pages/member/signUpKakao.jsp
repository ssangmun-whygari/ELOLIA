		...
		<div class="container">
			<div class="row">
              ...
              <div class="col-sm-12">
                ...
                <label for="reg-ad">*주소</label> 
                <input class="form-control" type="text" name="address" id="address" readonly onclick="selectAddress();">
              ...
              <div class="col-sm-6">
								<div class="form-group" style="margin-bottom: 0px">
									<label for="reg-ad">*우편번호</label> 
                  <input class="form-control" type="text" name="zipCode" id="zipCode" readonly onclick="selectAddress();">
                  <span id="zipCodeStatus"></span>
									<input type="hidden" value="">
								</div>
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="basicAddress" name="basicAddress" value="기본주소">
                  <label class="form-check-label" for="basicAddress">기본 주소로 설정</label>
								</div>
							</div>
              <div class="col-sm-6">
								<div class="form-group">
									<label for="reg-ad2">상세 주소</label> 
                  <input class="form-control" type="text" name="address2" id="address2">
                  <span id="address2Status"></span>
                  <input type="hidden" value="">
								</div>
							</div>
              <div class="col-sm-12">
								<div class="form-group addressName">
									<label for="reg-ad">배송지명</label> 
                  <input class="form-control" type="text" name="addressName" id="addressName">
								</div>
							</div>
							<div class="form-group">
								<span id=""></span> <input type="hidden" value="">
