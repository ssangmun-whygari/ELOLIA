...
public class LoginInterceptor extends HandlerInterceptorAdapter {
   ...
   private MemberService memberService;
	 ...
	 public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		 ...
		 Object rememberPath = ses.getAttribute("rememberPath");
		 if (rememberPath != null) {
			 ses.setAttribute("redirectURL", rememberPath.toString());
			 System.out.println("loginInterceptor.prehandle()에 의해 세션의 redirectURL를 " + rememberPath.toString() + " 로 설정");
