...
public class KakaoUtil {
	...
	public void getCode(HttpServletResponse response) throws FileNotFoundException, IOException {
		String url = this.getCodeUrl + "?redirect_uri=" + this.redirectUri + "&client_id=" + this.key
	...
	public String getAccessToken(String code) {
		...
		form.add("client_id", this.key);
		form.add("redirect_url", this.redirectUri);
		form.add("code", code);
		form.add("client_secret", this.client_secret);
		
		HttpEntity<MultiValueMap<String, String>> entity = new HttpEntity<>(form, headers);
		
		ResponseEntity<Map> response = this.restTemplate.postForEntity(this.getTokenUrl, entity, Map.class);
	...
	public MemberDTO getUserInfo(String accessToken) {
		...
		JsonObject kakaoAccount = gson.fromJson(body.get("kakao_account").toString(), JsonObject.class);
	...
	private void readProperties() throws FileNotFoundException, IOException {
		...
		this.userInfoRequestUrl = prop.get("userInfoRequestUrl") + "";
	}
