...
//    }
	...
	public String homePage(Model model, HttpServletResponse response, HttpServletRequest request) {
		...
		List<HomeProductDTO> newProducts = new ArrayList<HomeProductDTO>(); 
		
		try {
			newProducts = hService.getNewProducts();
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		System.out.println("mainBannerList : " + mainBannerList);
		System.out.println("subBannerList : " + subBannerList);
